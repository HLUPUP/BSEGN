...
class Loss(nn.Module):
        ...
        for single_loss in loss_string.split('+'):
            ...
            if name in loss_class_dict:
                self.loss_list.append({ 'name': name,
                                        ...
                                        'func2':loss_class_dict['self_L2'](),
                                        'cf_num':loss_class_dict['cf_num'](),
                                        'cf_num_1':loss_class_dict['cf_num_1'](),
                                        'cf_num_2':loss_class_dict['cf_num_2'](),
                                        'ratio': ratio})
            else:
    ...
    def forward(self, input_data, model_output, data, module,epoch, loss_name=None, change_name=None, ratio=1.0):
        '''
        ...
        '''
        loss_arg = (input_data, model_output, data, module,epoch)
        ...
        for single_loss in self.loss_list:
            ...
            cf_num['cf_num']=single_loss['cf_num'](*loss_arg)

        for single_loss in self.loss_list:
            cf_num_1['cf_num_1']=single_loss['cf_num_1'](*loss_arg)

        for single_loss in self.loss_list:
            cf_num_2['cf_num_2']=single_loss['cf_num_2'](*loss_arg)

        return losses, tmp_info,cf_num,cf_num_1,cf_num_2
