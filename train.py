...
def main():
    ...
    args.add_argument('-c', '--config',       default='CUSTOM',  type=str) # HL None
    args.add_argument('-r', '--resume' ,default=False, action='store_true')#default=True
    args.add_argument('-g', '--gpu',          default='0',  type=str) # HL None
